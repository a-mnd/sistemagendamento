...
//$cancelaSQL->execute(['id_agendamento' => $id_agendamento]);

?>
<div id="modalCancel"> <!--style="z-index:1000;"-->
    <div class="divFlex">
        <form id="CancelaForm" method="post" action="../admin/delete_agendamento.php">
            <h1 class="certeza">Você tem certeza?</h1>
            <input type="hidden" name="id_agendamento" id="id_agendamento" value="<?= $id_agendamento ?>">
            <div class="grupo-input">
                <div class="naocancela"><a href="NewhistoricoAgend.php">Não</div>
